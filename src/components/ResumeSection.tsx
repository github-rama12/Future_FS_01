import { Download, GraduationCap, Target, Code2, Award, Trophy } from "lucide-react";
import { useScrollAnimation } from "@/hooks/useScrollAnimation";

const education = [
  {
    degree: "B.Tech – Computer Science & Engineering; CGPA: 8.10",
    school: "Raghu Engineering College, Vishakhapatnam, Andhra Pradesh",
    period: "July 2023 – Present",
    desc: "Currently pursuing B.Tech with focus on full-stack development, data structures, algorithms, and machine learning.",
  },
  {
    degree: "Diploma (Polytechnic); Percentage: 85.6%",
    school: "Balaji Polytechnic College, Vizianagaram, Andhra Pradesh",
    period: "April 2021 – March 2024",
    desc: "Completed Polytechnic diploma with strong academic performance.",
  },
  {
    degree: "Matriculation (SSC); Percentage: 96.67%",
    school: "Gayatri School, Srikakulam, Andhra Pradesh",
